    ...
    <div className="fixed bottom-6 right-6 z-50 pointer-events-none flex flex-col items-end">
      {wa && (
        <a
          href={`https://wa.me/${wa}`}
          aria-label="WhatsApp"
          className={`w-12 h-12 rounded-sm bg-[#25D366] text-white flex items-center justify-center shadow-lg hover:scale-110 transition-all duration-300 pointer-events-auto absolute right-0 ${
