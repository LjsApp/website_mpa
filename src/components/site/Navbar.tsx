    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <Link to="/" className="group flex items-center gap-2">
          ...
          <span className="font-display text-[11px] sm:text-sm md:text-lg tracking-wide text-primary-foreground uppercase whitespace-nowrap">{name}<span className="text-accent">.</span></span>
            </>
          )}
        </Link>
