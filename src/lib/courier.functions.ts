...
export const COURIERS = [
  ...
  { code: "ide",             label: "ID Express",               icon: "📮" },
  { code: "wahana",          label: "Wahana",                   icon: "🚚" },
  { code: "rpx",             label: "RPX",                      icon: "📦" },
  { code: "pcp",             label: "PCP Express",              icon: "📫" },
  { code: "jet",             label: "JET Express",              icon: "✈️" },
  { code: "rex",             label: "Royal Express",            icon: "👑" },
  { code: "first",           label: "First Logistics",          icon: "1️⃣" },
  { code: "spx",             label: "Shopee Express",           icon: "🛍️" },
  { code: "kgx",             label: "KGX Express",              icon: "📬" },
  { code: "jxe",             label: "JX Express",               icon: "🔶" },
  { code: "jnt_cargo",       label: "J&T Cargo",                icon: "🏭" },
  { code: "lex",             label: "LEX (Lazada Express)",     icon: "🛒" },
  { code: "indah_cargo",     label: "Indah Cargo",              icon: "📊" },
  { code: "dakota",          label: "Dakota Cargo",             icon: "🚛" },
  { code: "ant_cargo",       label: "Ant Cargo",                icon: "🐜" },
  { code: "next_logistik",   label: "Next Logistics",           icon: "➡️" },
  { code: "gtl",             label: "GTL",                      icon: "🔷" },
  { code: "kurir_tokopedia", label: "Tokopedia Courier (TLP)",  icon: "🟩" },
] as const;
